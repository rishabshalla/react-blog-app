          ...
          .map((content) => (
            <>
              ...
              <p className="article-description">
                This is about {content.title} which is popular on the social
                media platform and much to say is that {content.body}
              </p>
              <div className="article-category-clap">
                <span className="article-category">{content.category}</span>
                <span className="article-clap">
                  <img
                    src={require("../icon/like.png")}
                    className="article-clap-image"
                    alt=""
                  />
                  95k
                </span>
